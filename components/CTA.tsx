      ...
      <div className="max-w-5xl mx-auto">
        <div className="relative bg-gradient-to-br from-purple-900 via-purple-800 to-purple-700 rounded-[2.5rem] p-12 md:p-16 text-center overflow-hidden">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-white/80 text-sm font-medium">Places disponibles ce mois-ci</span>
          </div>

          <h2 className="text-4xl md:text-5xl font-black text-white mb-4 relative z-10">
            Prêt à lancer votre projet ?
          </h2>
          <p className="text-purple-200 text-lg mb-10 max-w-xl mx-auto relative z-10">
            Devis gratuit en 24h. Pas d&apos;engagement, pas de surprise. Juste votre site livré rapidement.
          </p>
